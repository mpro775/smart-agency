      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Tabs defaultValue="content" className="space-y-6">
          <TabsList className="bg-slate-800 border border-slate-700">
            <TabsTrigger value="content" className="data-[state=active]:bg-slate-700">المحتوى</TabsTrigger>
          ...
          <TabsContent value="content" className="space-y-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">معلومات المقال</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label className="text-slate-200">المقتطف</Label>
                  <Textarea
                    {...register('excerpt')}
                    className="bg-slate-700/50 border-slate-600 text-white"
                ...
                <div className="space-y-2">
                  <Label className="text-slate-200">الوسوم</Label>
                  <Input
                    className="bg-slate-700/50 border-slate-600 text-white"
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">محتوى المقال *</CardTitle>
              </CardHeader>
              <CardContent>
                <Controller
                  name="content"
          ...
          <TabsContent value="media">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">صورة الغلاف</CardTitle>
              </CardHeader>
              <CardContent>
                <Controller
                  name="coverImage"
