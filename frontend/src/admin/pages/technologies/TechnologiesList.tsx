...
export default function TechnologiesList() {
  ...
  return (
    <div dir="rtl">
      <PageHeader
        title="التقنيات"
        description="إدارة التقنيات المستخدمة في المشاريع"
        createLink="/admin/technologies/new"
        createLabel="إضافة تقنية"
      />
      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
          {Object.entries(groupedByCategory).map(([category, techs]) => (
            <div key={category}>
              <h3 className="text-lg font-semibold text-white mb-4" dir="rtl">
                {category}
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {techs.map((tech) => (
      ...
      <ConfirmDialog
        ...
        title="حذف التقنية"
        description="هل أنت متأكد من حذف هذه التقنية؟"
        confirmText="حذف"
