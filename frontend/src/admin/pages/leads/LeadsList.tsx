...
const statusOptions: { value: LeadStatus; label: string; color: string }[] = [
  { value: 'New' as LeadStatus, label: 'جديد', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
  { value: 'Contacted' as LeadStatus, label: 'تم التواصل', color: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
  { value: 'Proposal Sent' as LeadStatus, label: 'تم إرسال العرض', color: 'bg-purple-500/20 text-purple-400 border-purple-500/30' },
  { value: 'Negotiation' as LeadStatus, label: 'تفاوض', color: 'bg-orange-500/20 text-orange-400 border-orange-500/30' },
  { value: 'Closed-Won' as LeadStatus, label: 'تم الإغلاق - نجاح', color: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' },
  { value: 'Closed-Lost' as LeadStatus, label: 'تم الإغلاق - خسارة', color: 'bg-red-500/20 text-red-400 border-red-500/30' },
];
...
export default function LeadsList() {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: { status?: LeadStatus; notes?: string } }) =>
          ...
          {selectedLead && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label className="text-slate-400">الخدمة</Label>
                  <p className="mt-1">{selectedLead.serviceType}</p>
                </div>
                <div>
