...
export default function BlogSidebar({
  ...
  return (
    <aside className="space-y-8">
      <section>
        <h2 className="mb-4 text-lg font-bold text-slate-950">{tr("الأكثر قراءة")}</h2>
      ...
      <section>
        <h2 className="mb-4 text-lg font-bold text-slate-950">{tr("وسوم شائعة")}</h2>
      ...
      <section className="rounded-2xl bg-slate-950 p-6 text-white">
        <h2 className="text-xl font-bold">{tr("هل لديك فكرة منتج؟")}</h2>
        <p className="mt-3 text-sm leading-7 text-slate-300">
          {tr("نحول الفكرة إلى تجربة رقمية واضحة وقابلة للنمو، من التخطيط وحتى الإطلاق.")}</p>
