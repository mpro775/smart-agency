      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <span className="rounded-full bg-primary/10 px-4 py-2 text-sm font-semibold text-primary">
            {tr("مركز معرفة Smart Agency")}</span>
          <h1 className="mt-6 text-4xl font-bold leading-tight text-slate-950 md:text-6xl">
            {tr("رؤى عملية لبناء منتجات رقمية تنمو بثقة")}</h1>
          <p className="mt-5 text-lg leading-8 text-slate-600">
            {tr("مقالات، أدلة، ودراسات حالة تساعدك على فهم التقنية، تجربة المستخدم، التجارة الإلكترونية، والأتمتة من زاوية تنفيذية واضحة.")}</p>
        </div>
